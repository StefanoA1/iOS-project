...
class tableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let spot7 = Spots(restaurant: "L'heure des Mets ", dish: "Big Baba au rhum", place:"Paris XV", description: "A very sweet dessert, french style served with additional stuff deppending on the day.", image: "bigbaba")
